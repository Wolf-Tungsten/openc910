...
// &Regs; @20
reg     [31:0]  dbg_snb_cycle;           
reg             dbg_snb_arvalid_q;       
reg     [39:0]  dbg_snb_araddr_q;        
reg             dbg_piu0_ar_req_q;       
reg             dbg_piu1_ar_req_q;       
reg             dbg_piu2_ar_req_q;       
reg             dbg_piu3_ar_req_q;       
reg             dbg_piu4_ar_req_q;       
reg             dbg_bmbif_bar_req_q;     
...
// SNB AR path toggles (debug)
always @(posedge forever_cpuclk or negedge cpurst_b)
begin
  if (!cpurst_b) begin
    dbg_snb_cycle <= 32'b0;
    dbg_snb_arvalid_q <= 1'b0;
    dbg_snb_araddr_q <= 40'b0;
    dbg_piu0_ar_req_q <= 1'b0;
    dbg_piu1_ar_req_q <= 1'b0;
    dbg_piu2_ar_req_q <= 1'b0;
    dbg_piu3_ar_req_q <= 1'b0;
    dbg_piu4_ar_req_q <= 1'b0;
    ...
    dbg_piu1_ar_req_q <= piu1_snb_ar_req;
    dbg_piu2_ar_req_q <= piu2_snb_ar_req;
    dbg_piu3_ar_req_q <= piu3_snb_ar_req;
    dbg_piu4_ar_req_q <= piu4_snb_ar_req;
    dbg_bmbif_bar_req_q <= bmbif_snb_bar_req;
  end
end
