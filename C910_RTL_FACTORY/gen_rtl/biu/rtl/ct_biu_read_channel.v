...
reg              rack_pending;            
reg              rack_valid;              
reg     [31 :0]  dbg_biu_rd_cycle;        
reg              dbg_pad_rvalid_q;        
reg              dbg_buf_rvalid_q;        
reg              dbg_is_ifu_q;            
reg              dbg_rack_full_q;         
reg              dbg_ifu_vld_q;           
reg              dbg_arvalid_q;           
reg              dbg_pad_arvalid_q;       
reg              dbg_pad_arready_q;       
reg              dbg_buf_arvalid_q;       
...
// BIU read data path toggles (debug)
always @(posedge coreclk or negedge cpurst_b)
begin
  if(~cpurst_b) begin
    dbg_biu_rd_cycle <= 32'b0;
    dbg_pad_rvalid_q <= 1'b0;
    dbg_buf_rvalid_q <= 1'b0;
    dbg_is_ifu_q <= 1'b0;
    dbg_rack_full_q <= 1'b0;
    dbg_ifu_vld_q <= 1'b0;
    dbg_arvalid_q <= 1'b0;
    dbg_pad_arvalid_q <= 1'b0;
    dbg_pad_arready_q <= 1'b0;
    ...
    dbg_rack_full_q <= rack_full;
    dbg_ifu_vld_q <= biu_ifu_rd_data_vld;
    dbg_arvalid_q <= arvalid;
    dbg_pad_arvalid_q <= biu_pad_arvalid;
    dbg_pad_arready_q <= pad_biu_arready;
    dbg_buf_arvalid_q <= cur_raddr_buf_arvalid;
  end
end
